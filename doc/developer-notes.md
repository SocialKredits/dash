...
socialkredits Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as socialkredits Core, where everyone uses
...
pay attention to for reviewers of socialkredits Core code.

General socialkredits Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: socialkredits Core uses tinyformat, which is type safe. Leave them out to avoid confusion
