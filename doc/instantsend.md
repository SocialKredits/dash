...
This mechanism has been integrated into Bitcore-Node-socialkredits which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/socialkreditspay/insight-api-socialkredits#web-socket-api](https://github.com/socialkreditspay/insight-api-socialkredits#web-socket-api)
* API: [https://github.com/socialkreditspay/insight-api-socialkredits#instantsend-transactions](https://github.com/socialkreditspay/insight-api-socialkredits#instantsend-transactions)
...
By default, the socialkredits Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the socialkredits Core daemon:
