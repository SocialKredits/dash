...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SocialKreditsNetwork") type = SocialKreditsNetwork;
    if(strType == "SocialKreditsNetworkVariable") type = SocialKreditsNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SocialKreditsNetwork) s = "SocialKreditsNetwork";
    if(type == SocialKreditsNetworkVariable) s = "SocialKreditsNetworkVariable";
