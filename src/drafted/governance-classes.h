 ...
 *
 *   // network
 *   CSocialKreditsNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.socialkredits.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSocialKreditsNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CSocialKreditsNetwork(UniValue objIn)
    {
...
// // can be under: SocialKreditsNetwork
// //   -- signature requirements : Key1(User)
// class CSocialKreditsNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == SocialKreditsNetwork);
//     // }
