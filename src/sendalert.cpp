...
2. run socialkreditsd with -printalert or -sendalert like this:
   /path/to/socialkreditsd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.socialkredits.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/socialkredits Core:0.12.0.58/"));
