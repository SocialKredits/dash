...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("socialkredits Core socialkredits-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  socialkredits-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded socialkredits transaction") + "\n" +
              "  socialkredits-tx [options] -create [commands]   " + _("Create hex-encoded socialkredits transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded socialkredits transaction
