    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("socialkredits-light"), QVariant("light"));
    ui->theme->addItem(QString("socialkredits-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("socialkredits-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("socialkredits-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("socialkredits-traditional"), QVariant("trad"));
