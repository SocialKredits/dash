    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("socialkredits Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About socialkredits Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  socialkredits-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the socialkredits in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 socialkredits, 0.1 socialkredits, 1 socialkredits and 10 socialkredits -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://socialkreditspay.atlassian.net/wiki/display/DOC/PrivateSend\">https://socialkreditspay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("socialkredits Core is shutting down...") + "<br /><br />" +
