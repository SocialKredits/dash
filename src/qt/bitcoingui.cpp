    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("socialkredits Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a socialkredits address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and socialkredits: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About socialkredits Core"), this);
    aboutAction->setStatusTip(tr("Show information about socialkredits Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for socialkredits Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your socialkredits addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified socialkredits addresses"));
    ...
    openAction->setStatusTip(tr("Open a socialkredits: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the socialkredits Core help message to get a list with possible socialkredits Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("socialkredits Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to socialkredits network", "", count));
    } else {
...
{
    QString strTitle = tr("socialkredits Core"); // default title
    ...
    // Append title to "socialkredits Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
