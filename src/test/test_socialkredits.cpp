...
#define BOOST_TEST_MODULE socialkredits Test Suite

#include "test_socialkredits.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_socialkredits_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
